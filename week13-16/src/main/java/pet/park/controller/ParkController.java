...
public class ParkController {
	...
	} // end of deleteAllContributor method ------
	...
	} // end of deleteContributor method ------
	...
	public PetParkData updatePetPark(@PathVariable Long contributorId,
		...
		log.info("Updating park {} for contributor with ID={}", petParkData,
				contributorId);
